...
- Do not pre-judge findings for the reviewer — never instruct a reviewer to
  ignore or not flag a specific issue. If the prompt you are writing contains
  "do not flag," "don't treat X as a defect," "at most Minor," or "the plan
...
on the most capable available model, using
superpowers:requesting-code-review's code-reviewer template (upstream
`../requesting-code-review/code-reviewer.md`, not vendored here — craft the
review prompt inline). Point it at the ledger's deferred-minor and parked
...
rulings, or rule on the load-bearing ones and ledger what you decided. There
is no second fix wave — residual load-bearing findings surface to your human
...
delete this plan's workspace — the git history is the record now. Sibling
