...
- `description`: Third-person, describes ONLY when to use (NOT what it does)
  ...
  - **NEVER summarize the skill's process or workflow** — a description that
    summarizes workflow creates a shortcut agents follow instead of reading
    the skill body
...
- Error messages, symptoms, synonyms, tool names, file types
...
**Techniques:** move details to tool help, use cross-references, compress
...
language. Good examples are complete, well-commented explaining WHY, from a
real scenario, and ready to adapt.

**Don't:** implement in 5+ languages, create fill-in-the-blank templates,
...
Test with academic questions, pressure scenarios, multiple combined
pressures. Success criteria: agent follows rule under maximum pressure.
...
| Complies, but output has the wrong shape | Positive recipe or contract: state what the output IS | Prohibition list |
...
- **Exemption clauses don't scope.** If part of the output must be exempt, restructure so the rule can't reach it.
